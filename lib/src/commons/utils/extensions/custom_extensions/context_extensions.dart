...
extension ContextExtensions on BuildContext {
  ...
  T responsiveValue<T>({
    ...
    final strictValues = [
      if (deviceWidth >= 1400) largeDesktop, //desktop is allowed
      if (deviceWidth >= 1200) desktop, //desktop is allowed
      if (deviceWidth >= 1080) smallDesktop, //tablet is allowed
      if (deviceWidth >= 720) largeTablet, //tablet is allowed
      if (deviceWidth >= 600) tablet, //tablet is allowed
      if (deviceWidth >= 450) largeMobile, //mobile is allowed
